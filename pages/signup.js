...
const Signup = () => {
  return (
    <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 my-20 md:my-52">
        <div>
          <Image className="mx-auto h-12 w-auto" src="/logo.png" width={220} height={40} alt="Your Company" />
          <h2 className="my-3 text-center text-3xl font-bold tracking-tight text-gray-900">Sign up</h2>
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="space-y-3 rounded-md shadow-sm">
            <div>
              <label htmlFor="email-address" className="sr-only">Full name</label>
