...
const Signup = () => {
  ...
  return (
    <>
      <div class="md:mb-80 mb-36 mt-20 px-3 md:px-0">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6" method="POST">
              ...
              <div className="space-y-3 rounded-md shadow-sm">
                ...
                <div>
                  ...
                  <input value={confirmPassword} onChange={handleChange} id="confirmPassword" name="confirmPassword" type="password" autocomplete="current-password" required className="relative block w-full appearance-none rounded-none rounded-b-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 md:text-md" placeholder="Confirm password" />
                </div>
