    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap items-center justify-center -m-4">
          {Object.keys(products).length === 0 && <p className='md:text-2xl md:my-36 md:py-56  mx-5 text-center my-36 py-28'>Sorry all the mugs are corrently out of stock. New stock comming soon. Stay Tuned.</p>}
